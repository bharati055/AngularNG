...
describe('Validate Account Creation-', function () {
	...
	it('Login to the application.', function () {
		loginPage.login_eu(env.spodApp.qa_eu.loginID, env.spodApp.qa_eu.password);
		browser.sleep(15000);
	...
	it('It should fill User Information Form.', function () {
		...
		accCreationPage.ele_createSubtAcc_fn().click();
		browser.sleep(10000);
	...
	it('It should fill New Company Information Form.', function () {
		...
		accCreationPage.ele_companyName_fn().clear();
