...
describe('Validate Account Creation-', function(){
	...
	it('Clicking the delete account link and delete the account', function () {

		accMainPage.ele_User_ExpandLink_admin_fn().click();
		browser.sleep(5000);
		//logger.info(data.accData.accountName);
		accMainPage.ele_User_deleteAccountLink_admin_fn().click();
		browser.sleep(5000);
        accMainPage.ele_continueButton_deleteAccountdialog_fn().click();
		browser.sleep(5000);
